...
class KdTree {
 ...
 public:
  ...
  void range_nearest_neighbors(const CoordPoint& point, double r,
                               KdNodeVector* result);
  void rectangle_range_search(double x_min, double x_max, double y_min, double y_max, double z_min, double z_max, KdNodeVector* result);
  void range_search(const CoordPoint& min_point, const CoordPoint& max_point, kdtree_node* node, KdNodeVector* result);
  bool bounds_overlap_rectangle(const CoordPoint& min_point, const CoordPoint& max_point, kdtree_node* node);
  bool node_within_rectangle(const CoordPoint& min_point, const CoordPoint& max_point, const CoordPoint& point);
};
